...
export const OidcConfiguration: UserManagerSettings = {
  ...
  redirect_uri: `${window.__env__.REACT_APP_ACCOUNTS_FRONTEND_ADDRESS}/signin-oidc`,
  post_logout_redirect_uri: `${window.__env__.REACT_APP_ACCOUNTS_FRONTEND_ADDRESS}/signout-oidc`,
  response_type: "code",
